...
export default function App({Component, pageProps}: AppProps) {
    return (<>
            ...
            {!!process.env.FACEBOOK_PIXEL && (<Script id="facebook-pixel" strategy="afterInteractive">
            ...
            {!!process.env.LINKEDIN_PIXEL && (<Script id="linkedin-pixel" strategy="afterInteractive">
                    {`
            ...
            {!!process.env.TWITTER_PIXEL && (<Script id="twitter-pixel" strategy="afterInteractive">
                    {`
          ...
          `}
            ...
            {!!process.env.SEGMENT_ID && (<Script id="segment" strategy="afterInteractive">
                    {`
          ...
          `}
            ...
            {!!process.env.REDDIT_PIXEL && (<Script id="reddit" strategy="afterInteractive">
                    {`
!function(w, d) {
    if (!w.rdt) {
